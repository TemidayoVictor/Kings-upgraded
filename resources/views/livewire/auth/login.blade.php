<div class="flex min-h-screen bg-[radial-gradient(133.44%_100%_at_50%_0%,_#2D251E_0%,_#1A1612_100%)]">
    ...
    <div class="flex-1 flex justify-center items-center px-6 dark">
        <div class="w-full max-w-sm space-y-6">
            ...
            <div class="space-y-4">
                <flux:button class="w-full bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold rounded-xl py-3 text-xs transition" href="{{route('auth.google')}}">
                    <x-slot name="icon">
