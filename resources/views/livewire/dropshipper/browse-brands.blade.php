<section class="w-full">
    ...
    <flux:heading class="sr-only">{{ __('Browse Brands') }}</flux:heading>

    <x-dropshippers.layout :heading="__('Browse Brands')" :subheading="__('See list of Brands you can Dropship for')">
        <div class="flex justify-end mb-4">
            <flux:button href="{{ route('dropshipper-applications') }}" size="sm" variant="primary">
                            ...
                            <div class="pt-10 p-4 flex flex-col flex-grow">
                                ...
                                <div class="space-y-2 mb-4 flex-grow">
                                    <div class="flex items-center text-sm text-gray-400">
                                        ...
                                        <span class="truncate">{{ $brand->categoryModel->name }} @if($brand->sub_category) / {{ $brand->subcategoryModel->name }} @endif</span>
                                    </div>
