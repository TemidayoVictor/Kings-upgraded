        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div class="lg:col-span-3 sticky top-28 space-y-8 hidden lg:block">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        >
                            ...
                            <i class="fa-solid fa-circle-nodes text-[10px] opacity-80"></i>
                        </button>
                ...
                <div class="pt-4 border-t border-neutral-200/60 space-y-3">
                    <h4 class="text-xs font-bold uppercase tracking-widest text-neutral-400">Filter By Price</h4>
            ...
            <div class="lg:col-span-9 space-y-8">
                ...
                <div class="bg-[var(--secondary)] p-4 rounded-2xl border border-neutral-200/60 flex flex-col gap-3 items-center justify-between lg:hidden shadow-xs">
                    ...
                    <!-- Sorting options dropdown element container (Visible only on smaller screens) -->
                    <div class="w-full">
                        <select
                            wire:model.live="sortBy"
        ...
        >
            ...
            <div class="relative bg-white rounded-[2em] max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-neutral-100 z-10">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 sm:p-10">
                        ...
                        @if($quickViewProduct->images->isNotEmpty())
                            <div class="flex gap-2.5 overflow-x-auto pb-1 no-scrollbar">
                                @foreach($quickViewProduct->images as $index => $extraImg)
                                    ...
                                    >
                                        <img src="{{ $imageAssetPath }}" alt="Thumbnail image link {{ $index }}" class="w-full h-full object-cover mix-blend-multiply rounded-md">
                                    </button>
                                @endforeach
                            </div>
                        @endif
                    ...
                    <div class="flex flex-col justify-between py-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                @foreach($values as $value)
                                                    <button class="px-4 py-2 bg-white text-neutral-700 rounded-xl border border-neutral-200 hover:border-brand-primary transition-all text-xs font-medium cursor-pointer">
                                                        {{ $value }}
                                                    </button>
                                                @endforeach
                                            </div>
                        ...
                        <button
                            ...
                            wire:loading.attr="disabled"
                            class="w-full bg-neutral-950 text-white text-xs font-medium tracking-widest uppercase py-4.5 rounded-xl hover:bg-brand-primary transition-colors mt-8 flex items-center justify-center gap-2.5 shadow-xl cursor-pointer"
                        >
                ...
                <button
                    ...
                    class="absolute top-5 right-5 text-neutral-400 hover:text-neutral-900 transition-colors w-10 h-10 rounded-full flex items-center justify-center hover:bg-neutral-50 cursor-pointer"
                >
